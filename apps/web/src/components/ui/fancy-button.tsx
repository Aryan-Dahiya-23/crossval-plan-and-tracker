...
export const fancyButtonVariants = tv({
  ...
  variants: {
    variant: {
      neutral: {
        root: 'bg-bg-strong-950 text-text-white shadow-fancy-buttons-neutral',
      },
      primary: {
        root: 'bg-primary-base text-text-white shadow-fancy-buttons-primary',
      },
      destructive: {
        root: 'bg-error-base text-text-white shadow-fancy-buttons-stroke',
      },
      basic: {
        root: [
          'bg-bg-white text-text-sub-600 shadow-fancy-buttons-stroke',
    ...
    size: {
      ...
      small: {
        root: 'h-9 gap-2.5 rounded-lg px-3',
        icon: '-mx-1',
      },
      xsmall: {
        root: 'h-8 gap-2 rounded-lg px-2.5',
        icon: '-mx-1',
      },
    },
  },
  compoundVariants: [
    {
      ...
      class: {
        root: [
          ...
          // before mask
          'before:mask-exclude before:bg-origin-border',
          // after
...
export { FancyButtonRoot as Root, FancyButtonIcon as Icon, FancyButtonRoot as FancyButton };
export default FancyButtonRoot;
