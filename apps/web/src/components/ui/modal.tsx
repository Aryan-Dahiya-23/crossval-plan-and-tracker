      ...
      <ModalOverlay className={overlayClassName}>
        <DialogPrimitive.Content
          ...
          className={cnExt(
            ...
            'rounded-20 bg-bg-white shadow-regular-md ring-1 ring-inset ring-stroke-soft-200',
            'focus:outline-none',
  ...
  return (
    ...
    >
      {children || (
        <>
          {Icon && (
            <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-bg-white ring-1 ring-inset ring-stroke-soft-200 shadow-regular-xs">
...
>(({ className, ...rest }, forwardedRef) => {
  return (
    <DialogPrimitive.Title
      ref={forwardedRef}
      className={cnExt('text-label-md font-medium text-text-strong', className)}
      {...rest}
    />
  );
});
