...
export const inputVariants = tv({
  slots: {
    root: [
      // base
      'group relative flex w-full overflow-hidden bg-bg-white text-text-strong shadow-regular-xs',
    ...
    affix: [
      // base
      'shrink-0 bg-bg-white text-paragraph-sm text-text-sub-600',
  ...
  variants: {
    ...
    hasError: {
      ...
      false: {
        root: ['hover:before:ring-stroke-sub'],
      },
    },
  },
  compoundVariants: [
...
export {
  ...
  InputRoot as InputRootComponent,
};
