...
export function QueryErrorState({
  ...
  return (
    <div
      role="alert"
      className={cn(
        'flex min-h-56 flex-col items-center justify-center rounded-12 border bg-bg-white px-6 py-10 text-center',
        className,
      )}
    >
      ...
      {onRetry && (
        <Button className="mt-5" variant="stroke" size="small" onClick={onRetry}>
